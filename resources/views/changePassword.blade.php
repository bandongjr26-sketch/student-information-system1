...
<div class="form-container mt-5">
    ...
    <form id="changePasswordForm" action="{{ route('password.update') }}" method="POST">
        ...
        <div class="mb-3" style="max-width: 420px; margin: 0 auto;">
            ...
            <input type="password" id="change_current_password" name="current_password" class="form-control styled-input" required>
        </div>

        <div class="mb-3" style="max-width: 420px; margin: 0 auto;">
            <label class="form-label fw-bold">New Password</label>
            <input type="password" id="change_new_password" name="new_password" class="form-control styled-input" required>
        </div>

        <div class="mb-4" style="max-width: 420px; margin: 0 auto;">
            <label class="form-label fw-bold">Re-enter Password</label>
            <input type="password" id="change_new_password_confirmation" name="new_password_confirmation" class="form-control styled-input" required>
        </div>
        ...
        <div class="text-center">
            <button type="submit" id="changePasswordBtn" class="gradient-btn btn-lg">Update Password</button>
        </div>
    </form>
</div>
@endsection
